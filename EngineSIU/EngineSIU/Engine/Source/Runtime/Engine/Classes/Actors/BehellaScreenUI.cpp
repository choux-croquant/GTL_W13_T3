...
void FBehellaGameInitScreenUI::CloseScreen(float ClosingTime)
{
...
void FBehellaGamePlayScreenUI::CloseScreen(float ClosingTime)
{
...
void FBehellaGameDeadScreenUI::CloseScreen(float ClosingTime)
{
}
...
void FBehellaGameOverScreenUI::CloseScreen(float ClosingTime)
{
